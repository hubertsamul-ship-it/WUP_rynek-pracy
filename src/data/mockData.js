...
export const DS = {
  ...
  polska: [6.2,6.1,6.0,5.9,5.8,5.7,5.6,5.7,5.8,5.9,6.0,6.0,6.0],
...
export const WOJ_DATA = [
  {n:'Warmińsko-maz.',  s:9.9},
  {n:'Podkarpackie',    s:9.6},
  {n:'Świętokrzyskie',  s:8.8},
  {n:'Lubelskie',       s:8.5},
  {n:'Kujawsko-pom.',   s:8.2},
  {n:'Zachodniopom.',   s:8.1},
  {n:'Podlaskie',       s:7.8},
  {n:'Opolskie',        s:6.7},
  {n:'Łódzkie',         s:6.6},
  {n:'Lubuskie',        s:6.1},
  {n:'Dolnośląskie',    s:5.6},
  {n:'Pomorskie',       s:5.6},
  {n:'Małopolskie',     s:5.0},
  {n:'Śląskie',         s:4.7},
  {n:'Mazowieckie',     s:4.5},
  {n:'Wielkopolskie',   s:3.8},
];
